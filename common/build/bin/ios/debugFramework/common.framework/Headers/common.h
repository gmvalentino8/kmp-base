...
__attribute__((swift_name("ResultUseCase")))
@interface CommonResultUseCase : KotlinBase <CommonKotlinx_coroutines_coreCoroutineScope>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)executeParameters:(CommonResultUseCaseParameters *)parameters onSuccess:(void (^)(id))onSuccess onError:(void (^)(CommonErrorEntity *))onError __attribute__((swift_name("execute(parameters:onSuccess:onError:)")));
@property (readonly) id<CommonKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResultUseCase.None")))
@interface CommonResultUseCaseNone : KotlinBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)none __attribute__((swift_name("init()")));
@end;

__attribute__((swift_name("ResultUseCase.Parameters")))
@interface CommonResultUseCaseParameters : KotlinBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end;
...
@interface CommonTestUseCase : CommonResultUseCase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
@interface CommonTestUseCaseParameters : CommonResultUseCaseParameters
- (instancetype)initWithTest:(NSString *)test update:(BOOL)update __attribute__((swift_name("init(test:update:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (BOOL)component2 __attribute__((swift_name("component2()")));
- (CommonTestUseCaseParameters *)doCopyTest:(NSString *)test update:(BOOL)update __attribute__((swift_name("doCopy(test:update:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *test __attribute__((swift_name("test")));
@property (readonly) BOOL update __attribute__((swift_name("update")));
@end;
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)executeParameters:(CommonUseCaseParameters *)parameters onComplete:(void (^)(id))onComplete __attribute__((swift_name("execute(parameters:onComplete:)")));
@property (readonly) id<CommonKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@end;
